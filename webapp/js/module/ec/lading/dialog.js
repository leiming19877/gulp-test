...
Dialog.prototype.setPosition = function () {
    ...
    if (typeof this.Top == "string" && this.Top.substring(this.Top.length - 1, this.Top.length) == "%") {
        var percentT = this.Top.substring(0, this.Top.length - 1) * 0;
        thisTop = bd.clientHeight * percentT - thisdialogDiv.scrollHeight * percentT;
    }
    if (typeof this.Left == "string" && this.Left.substring(this.Left.length - 1, this.Left.length) == "%") {
        var percentL = this.Left.substring(0, this.Left.length - 1) * 0;
...
Dialog.setBgDivSize = function () {
	...
	if(Dialog.bgDiv){
			if(isIE6){
				...
				Dialog.bgDiv.style.height = bd.clientHeight + "px";
				Dialog.bgDiv.style.width = bd.clientWidth + "px";
			}
		}
};
...
Dialog.prototype.create = function () {
    ...
    if (DialogDivWidth > bd.clientWidth) this.Width = Math.round(bd.clientWidth);
    if (DialogDivHeight > bd.clientHeight) this.Height = Math.round(bd.clientHeight - (this.ShowButtonRow ? 40 : 0) - (this.ShowMessageRow ? 50 : 0));
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + this.Width + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr valign="top">\
      <td align="center" style="padding:0px;"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_' + this.ID + '" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50;padding:0px;"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#eaece9 url(' + IMAGESPATH + 'dialog_bg.jpg) no-repeat scroll right top;" id="_MessageTable_' + this.ID + '">\
                <tr>\
          ...
          <tr>\
            <td valign="top" align="center" style="padding:0px;"><div id="_Container_' + this.ID + '" style="position: absolute;width:'+this.Width+'px;left:'+this.Left+'px;top:'+this.Top+'px;height: ' + this.Height + 'px;">\
	...
	' + (function (obj) {
        ...
        if (obj.URL) return '<iframe width="100%" height="100%" frameborder="0" style="1px none;" allowtransparency="true" id="_DialogFrame_' + obj.ID + '" src="' + obj.displacePath() + '"></iframe>';
        return "";
    })(this) + '\
              </div></td>\
          </tr>\
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
		...
		var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background-color:white;opacity:0.4;filter:alpha(opacity=40);width:100%;height:100%;"></div>';
