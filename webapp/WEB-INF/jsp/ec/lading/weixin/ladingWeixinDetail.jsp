...
<div style="height:100%;overflow-y:auto;"> 
	...
	<div id="show" class="">
	     <div class="connet">
	        ...
	        <div class="erwm">
		        <img style="height:100px;width:100px" id="img" src="${ctx}/steel/lading/weixin/createCode.pfv?ladingPasswordShow=${ladingDetail.ladingPasswordShow}" >
...
<script type="text/javascript">
    //加载主模板块
    seajs.use("module/ec/lading/ladingWeixinDetail.js");
</script>
