...
<%@include file="/WEB-INF/jsp/ec/lading/weixin/ladingTag.jsp"%>
...
<body>
	<div id="content" class="">
		<%@include file="/WEB-INF/jsp/ec/lading/weixin/selectLicenseNo.jsp"%>
...
<script type="text/javascript">
	...
	function switchVerifyType(verifyType){
		...
		var url = "${ctx}/steel/lading/weixin/toSetLadingPick.pfv?ladingId="+ladingId +"&verifyType="+verifyType+"&ladingType="+ladingType+"&evLadingId="+evLadingId;
	...
	function doSaveLicenseNo(){
		var url = "${ctx}/steel/lading/weixin/saveLadingDelivery.pfv?";
				...
				if(data.resultCode == 0) {
					new jConfirm("提货信息已保存，是否跳转到列表页面", "提示", function(y){
						if(y) {
							...
							var url = "${ctx}/steel/lading/weixin/queryLadingWeixinInfo.pfv?phone="+phone+"&verifyStatus=-1&range=1-10&rm="+Math.random();
