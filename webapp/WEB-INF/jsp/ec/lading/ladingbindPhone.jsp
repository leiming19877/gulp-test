 ...
 <div class="">
          <div class="connet">
                <div class="List lading_xq"style="line-height: 70px;"><!--详情列表样式 请添加样式 lading_xq  -->
                     <form id="bind" action="${ctx}/lading/bindOpenidAndPhone.pfv"mothod="post"onsubmit="return checkAll(this)">
                     <ul>
                     ...
                     <input type="hidden"name=openid value="<%=signPackage.getOpenid()%>">
                      ...
                      <form id="query" action="${ctx}/lading/queryLadingWeixinInfo.pfv"mothod="post"onsubmit="javascript:{this.disabled=true;document.query.submit();}">
                    ...
                    <form id="transLogin" method="post"action="${ctx}/lading/weixinLading.pfv"">
