...
.ui-page {
    ...
    background-image: url(${ctx}/images/base/photo-order.gif.);
}
/** 扩展ui-page **/
.ui-page.hasPhoto {
...
.more{
    ...
    background-image: url(${ctx}/images/icons/icon_go_witre.png);
}
	...
	<div data-role="page" >
		...
		<div class="ui-bottom">
			...
			<div data-role="footer" class="submitNav" >
				<div id="choose" class="choose">语音提交计划</div>
				<div id="submit" class="submit">提交计划</div>
			</div>
	    </div>
	</div>
</form>
