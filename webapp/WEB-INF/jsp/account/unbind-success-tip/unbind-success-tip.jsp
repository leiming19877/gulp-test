...
<head>
    ...
    //加载本模块样式
    seajs.use("${ctx}/css/module/account/unbind-success-tip/unbind-success-tip.css");
</script>
</head>
<body>
            ...
            <div id="g-content" class="g-content">
                ...
                <div class="weui_msg">
                    ...
                    <div class="weui_text_area">
                        ...
                        <p class="weui_msg_desc">你已成功解绑账号<b>【${param.userName}】</b>。</p>
                    </div>
                    <div class="weui_opr_area">
                        <p class="weui_btn_area">
                            <a id="bind-btn" href="javascript:;" class="weui_btn weui_btn_primary">重新绑定账号</a>
