...
<body>
   ...
   <div data-role="content" id="totalcontent"> 
		<article>
			...
			<input name="shippingName"value="小二"placeholder="收货人姓名"required="required">
			<div><span>收货人电话</span></div>
			<input name="phone"value="12345678900"placeholder="收货人电话"required="required">
			<input type="submit"value="保存为常用">
		...
		<article class="block_l"style="float:left;width:80%;">
			...
			<section class="line">
				<div><span>序号</span><span style="padding-left: 3%;padding-right: 3%;">收货人</span><span>收货人电话</span></div>
			</section>
			<div style="clear:both;"></div>
		</article>
