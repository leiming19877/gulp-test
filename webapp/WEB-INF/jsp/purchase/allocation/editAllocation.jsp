...
<script type="text/javascript">
    //加载本模块样式
        seajs.use("${ctx}/css/module/purchase/allocation/allocation-detail.css");
</script>
...
<body>
    ...
    <div class="weui_dialog_confirm" id="dialog1" style="display: none;">
		    ...
		    <div class="weui_dialog">
		        <div class="weui_dialog_hd"><strong class="weui_dialog_title">实提确认</strong></div>
	...
	<div class="weui_dialog_confirm" id="dialog2" style="display: none;">
	    ...
	    <div class="weui_dialog">
	        ...
	        <div id="quantity" class="weui_cell weui_cell_">
	        	<input class="m-al-dialog-quantity" min="0" max="10000" maxlength="5" type="number" placeholder="请输入数量"name="quantity">
	        </div>
	...
	<div class="weui_dialog_confirm" id="dialog3" style="display: none;">
	    ...
	    <div class="weui_dialog">
	        ...
	        <div id="weight" class="weui_cell weui_cell_">
	        	<input class="m-al-dialog-weight" min="0" max="10000" maxlength="5" type="number" placeholder="请输入重量"name="weight">
	        </div>
	        <div class="weui_dialog_ft m-receipt-dft">
	            <a href="javascript:;" class="weui_btn_dialog default">取消</a>
	            <a href="javascript:;" class="weui_btn_dialog primary">确定</a>
...
<script type="text/javascript">
    //加载主模板块
    seajs.use("module/purchase/allocation/editAllocation.js");
</script>
