...
<script type="text/javascript">
    //加载本模块样式
    seajs.use("${ctx}/css/module/purchase/receipt/order-list.css");
</script>
            ...
            <div id="g-content" class="g-content" style="height: 100%;">
				<div id="order-tab" class="weui_tab">
					<div class="weui_navbar">
						<div class="weui_navbar_item" data-query-type="order_receipt">订单收货</div>
					</div>
					<div class="weui_tab_bd">
					   <div id="wrapper" >
			                <div id="scroller">
			                    ...
			                    <div id="tab-content">
			                        <div id="order_receipt" class="m-order-list">
			                            <ul class="list">
			                            </ul>
