...
<div class="weui_dialog_confirm" id="dialog2" style="display: none;">
    ...
    <div class="weui_dialog">
        ...
        <div id="money" class="weui_cell weui_cell_">
        	<input class="u-dialog-money-ipt" min="0" max="10000" maxlength="6" type="number" placeholder="请输入"name="weight">
        </div>
        <div class="weui_dialog_ft">
            <a href="javascript:;" class="weui_btn_dialog default">取消</a>
            <a href="javascript:;" class="weui_btn_dialog primary">确定</a>
...
<div class="weui_dialog_confirm" id="dialog3" style="display: none;">
    <div class="weui_mask"></div>
    <div class="weui_dialog">
        <div class="weui_dialog_hd"><strong class="weui_dialog_title">请输入仓库名</strong></div>
        <div id="warehouse" class="weui_cell weui_cell_"style="padding-bottom: 0px;">
        	<input class="u-dialog-money-ipt" type="text" placeholder="请输入仓库名"name="wavehouse">
        </div>
        <div id="warehouse-info"style="padding-bottom: 10px;">
        </div>
...
<script type="text/javascript">
    //加载主模板块
    seajs.use("module/purchase/quoteForWuHan/quote.js");
</script>
