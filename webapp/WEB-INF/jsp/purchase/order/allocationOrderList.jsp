...
<script type="text/javascript">
    //加载本模块样式
    seajs.use("${ctx}/css/module/purchase/order/order-list.css");
</script>
            ...
            <div id="g-content" class="g-content" style="height: 100%;">
				<div id="order-tab" class="weui_tab">
					<div class="weui_navbar">
						<div class="weui_navbar_item" data-query-type="order_shipping">订单中心</div>
					</div>
...
<script type="text/javascript">
    ...
    //加载主模板块
    seajs.use("module/purchase/order/allocationOrderListPage.js");
</script>
</html>